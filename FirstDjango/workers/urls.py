...
from workers.views import WorkersListView, WorkerUpdateView, WorkerDeleteView, WorkerCreateView, WorkerDetailView, ResumeCreateView, ResumeUpdateView, ResumeDeleteView, ContactCreateView
